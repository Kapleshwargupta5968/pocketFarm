      ...
      <div className="font-['Outfit',sans-serif] text-slate-800 overflow-x-hidden bg-slate-50">
        ...
        <section className="relative min-h-screen flex items-center justify-center px-8 py-24 bg-[radial-gradient(circle_at_top_right,_#e0f2fe_0%,_#f0fdf4_40%,_#ffffff_100%)] overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center max-w-7xl mx-auto text-center lg:text-left gap-16 w-full">
            ...
            {/* Hero Image */}
            <div className="flex-1 flex justify-center items-center relative mt-12 lg:mt-0 w-full">
        ...
        {/* Features Section */}
        <section className="px-8 py-32 bg-white relative z-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* Feature 1 */}
            <div className="group relative bg-white border border-slate-100 rounded-3xl p-10 hover:-translate-y-2 hover:shadow-[0_20px_25px_-5px_rgba(0,0,0,0.1),_0_10px_10px_-5px_rgba(0,0,0,0.04)] hover:border-transparent transition-all duration-300 overflow-hidden z-10">
              {/* Top Gradient Border */}
        ...
        <section className="px-8 py-32 bg-slate-50 relative z-10">
          <div className="text-center mb-20">
