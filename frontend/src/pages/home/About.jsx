  ...
  return (
    <LandingLayout>
      ...
      <section className="relative py-24 bg-gradient-to-br from-emerald-600 to-teal-700 px-6 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-white relative z-10">
          {stats.map((s, i) => (
            <div key={i} className="p-6 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-md hover:bg-white/10 transition-colors duration-300 animate-fade-in-up" style={{ animationDelay: `${i * 100}ms` }}>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {values.map((v, i) => (
              <div
                key={i}
                className="bg-white rounded-3xl p-10 border border-slate-100 shadow-xl shadow-slate-200/40 hover:shadow-2xl hover:shadow-teal-500/10 transition-all duration-300 flex flex-col sm:flex-row gap-6 items-start group transform hover:-translate-y-1 animate-fade-in-up"
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-10">
            {team.map((member, i) => (
              <div
                key={i}
                className="group relative bg-white rounded-3xl p-10 text-center border border-slate-100 shadow-lg shadow-slate-200/50 hover:shadow-2xl hover:shadow-emerald-500/15 transition-all duration-500 transform hover:-translate-y-2 animate-fade-in-up overflow-hidden"
      ...
      <section className="py-24 px-6 relative overflow-hidden bg-slate-950 text-center">
        ...
        <div className="max-w-4xl mx-auto relative z-10 p-12 lg:p-20 bg-slate-900/50 backdrop-blur-2xl border border-slate-800 rounded-[3rem] shadow-2xl animate-fade-in-up">
